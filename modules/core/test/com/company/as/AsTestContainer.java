...
public class AsTestContainer extends TestContainer {

    public AsTestContainer() {
        super();
    ...
    public static class Common extends AsTestContainer {

        public static final AsTestContainer.Common INSTANCE = new AsTestContainer.Common();
